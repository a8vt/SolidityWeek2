...
async function main() {
  ...
  console.log("Printing voting power: ");
  const votingPower = await myTokenContract.getVotes(voterAddress);
  console.log (`The account ${voterAddress} has a voting power of ${votingPower}. `)
  };
